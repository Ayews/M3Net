...
def train_one_epoch(epoch,epochs,model,opt,train_dl):
    ...
    for i, data_batch in enumerate(progress_bar):
        ...
        loss4  = wbce(out2,label_14)#F.binary_cross_entropy_with_logits(out2, label_14)# + iou_loss(out2, label_14)
        loss3  = wbce(out3,label_28)#F.binary_cross_entropy_with_logits(out3, label_28)# + iou_loss(out3, label_28)
        loss2  = wbce(out4,label_56)#F.binary_cross_entropy_with_logits(out4, label_56)# + iou_loss(out4, label_56)
        loss1  = wbce(out5,label_224)#F.binary_cross_entropy_with_logits(out5, label_224)# + iou_loss(out5, label_224)
